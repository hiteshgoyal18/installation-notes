...
public class SendMailUsingSMTPJava 
{
    ...
    public static void main( String[] args )
    {
		...
		final String password = "hitesh@goyal.com"; // correct password for gmail id
		...
		new SendMailUsingSMTPJava(session, toEmail,"TLSEmail Testing Subject", "TLSEmail Testing Body");
    }
}
